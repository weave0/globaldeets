...
(function () {
    ...
    card.innerHTML = `
            ...
            <div class="project-footer">
                ...
                <div class="footer-actions">
                    ...
                    <a href="contact.html?project=${encodeURIComponent(
                      project.name
                        .toLowerCase()
                        .replace(/\s+/g, '-')
                        .replace(/[^a-z0-9-]/g, '')
              ...
              project.updates && project.updates.length
                ...
                <ul style="list-style:none; padding:0;">
                    ${project.updates
                      .slice(0, 5)
                      .map(
                        u => `<li style="padding:0.75rem; background: var(--bg-card); border-radius:0.5rem; margin-bottom:0.5rem;">
  ...
  function updateStats(projectsToCount) {
    ...
    recentUpdatesEl.textContent = projects.filter(
      p => new Date(p.lastUpdated) > thirtyDaysAgo
    ).length;
  }

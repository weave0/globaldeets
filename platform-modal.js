...
(function () {
  ...
  const platformData = {
    'healthcare-intelligence': {
      title: 'National Healthcare Strategic Intelligence',
      category: 'Healthcare Analytics',
      categoryColor: '#10b981',
      description:
        'Real-time dashboard analyzing 433K+ public records across a nationwide healthcare network with facility mapping and operational benchmarks.',
      fullDescription:
        'This platform demonstrates large-scale healthcare analytics built entirely from public data sources, tracking organizational structure, revenue patterns, and strategic expansion opportunities across the healthcare sector.',
      stats: [
        { label: 'Records Analyzed', value: '433,215', color: '#8b5cf6' },
        { label: 'Public Data Sources', value: 'IRS 990 + NPPES', color: '#6366f1' },
        { label: 'States Covered', value: 'Multi-state', color: '#60a5fa' },
      ...
      insights: [
        {
          ...
          content:
            'Analysis of provider distribution and facility capacity across multiple states, powered by IRS 990 and NPPES public filings.',
        },
        {
          title: 'Financial Patterns',
          content:
            'Revenue and expenditure tracking across nonprofit healthcare entities with transparent public data sourcing.',
        },
        {
          title: 'Capacity Modeling',
          content:
            '92% inpatient capacity utilization modeling demonstrates operational efficiency benchmarking capabilities.',
        },
      ],
      methodology:
        'Data sourced from IRS 990 filings, NPPES provider registry, ProPublica Nonprofit Explorer, and public health registries. All information is publicly available and ethically collected. DuckDB provides real-time aggregation with sub-100ms query latency.',
      liveUrl: '#',
